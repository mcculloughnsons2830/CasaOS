...
export const ARCHETYPES: Archetype[] = [
  ...
  },
  {
    ...
    trend: 'rising',
    reflecting: 12100,
    read: 'Every face in the field is a surface. When MIRROR holds steady, what irritates you is a message, not an enemy. Read the reflection before you react to it.',
  ...
  },
  {
    ...
    trend: 'falling',
    reflecting: 9200,
    read: 'The fertile emptiness. VOID receding means the silence is lifting and form wants to return. Do not rush to fill it — notice what naturally grows back first.',
  ...
  },
  {
    ...
    trend: 'falling',
    reflecting: 11000,
    read: 'The face built for approval. MASK thinning is the facade losing its grip — the exact moment the real one underneath can finally breathe. Let it slip.',
