...
const en = {
  ...
  hero: {
    badge: '100% Free on Google Play',
    title1: 'A horoscope that is',
    titleAccent: 'actually yours.',
    sub: 'NASA/JPL ephemeris precision fused with advanced AI — a chart computed for your exact coordinates, read for the misfit you actually are. No generic templates. No copy-paste readings.',
...
const it: Dict = {
  ...
  hero: {
    badge: '100% Gratis su Google Play',
    title1: 'Un oroscopo che è',
    titleAccent: 'davvero tuo.',
    sub: 'Precisione delle effemeridi NASA/JPL fusa con un’IA avanzata — un tema calcolato sulle tue coordinate esatte, letto per il misfit che sei davvero. Nessun modello generico. Nessuna lettura copia-incolla.',
...
const es: Dict = {
  ...
  hero: {
    badge: '100% Gratis en Google Play',
    title1: 'Un horóscopo que es',
    titleAccent: 'realmente tuyo.',
    sub: 'Precisión de las efemérides NASA/JPL fusionada con IA avanzada — una carta calculada para tus coordenadas exactas, leída para el inadaptado que realmente eres. Sin plantillas genéricas. Sin lecturas copiar-pegar.',
